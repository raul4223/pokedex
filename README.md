<p align="center">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="160" height="160" style="image-rendering: pixelated; shape-rendering: crispEdges;">
    <!-- Black Outline -->
    <g fill="#1E2022">
...
Uma aplicação de Pokédex simples e moderna construída com [Angular](https://angular.dev/) que consome a [PokéAPI](https://pokeapi.co/).

## 🚀 Funcionalidades

- Listagem de Pokémon
- Busca por nome ou ID
- Visualização de detalhes (tipo, estatísticas, etc.)
